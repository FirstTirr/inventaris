...
import BarangBaikBc from "./barangBaikBc";
import BarangRusakBc from "./barangRusakBc";

export default function NavBc() {
  ...
  return (
    <>
      ...
      <div className="px-8 py-4">
        ...
        {active === "barang baik" && <BarangBaikBc />}
        {active === "barang rusak" && <BarangRusakBc />}
      </div>
    </>
  );
}
