...
const items = [
  ...
  {
    label: "total semua barang rusak",
    value: 60,
    icon: (
      <svg width="48" height="48" viewBox="0 0 24 24" fill="none">
        <circle cx="12" cy="12" r="12" fill="#00f" />
