...
export default function Login() {
  ...
  return (
    <div
      className="min-h-screen w-full flex flex-col items-center justify-center relative overflow-hidden bg-cover"
    >
      {/* Judul kiri atas */}
      <div
      ...
      <div className="w-full flex flex-col items-center justify-center mt-8">
        ...
        <div className="w-full max-w-[380px] flex flex-col items-center">
          ...
          <button className="w-full bg-[#1877f2] hover:bg-blue-700 text-white font-bold text-lg rounded-md py-3 mt-2 mb-2 transition-all font-[Montserrat,sans-serif]">
            Login
          </button>
