...
import BarangBaikDkv from "./barangBaikDkv";
import BarangRusakDkv from "./barangRusakDkv";

export default function NavDkv() {
  ...
  return (
    <>
      ...
      <div className="px-8 py-4">
        ...
        {active === "barang baik" && <BarangBaikDkv />}
        {active === "barang rusak" && <BarangRusakDkv />}
      </div>
    </>
  );
}
